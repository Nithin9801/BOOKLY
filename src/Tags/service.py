...
class TagService:
    ...
    async def add_tags_to_book(self,book_uid:UUID,tag_data:TagAddModel,session:AsyncSession):
        """Add tag to book"""
    ...
    async def update_tag(self,tag_uid:UUID,Tag_update_data:TagCreateModel,session:AsyncSession):
        """Update a tag"""
